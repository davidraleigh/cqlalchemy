...
Welcome to `cqlalchemy` contributor's guide.
...
If you experience bugs or general issues with `cqlalchemy`, please have a look
...
You can help improve `cqlalchemy` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`cqlalchemy` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `cqlalchemy`'s files. While this mechanism can
...
```
conda create -n cqlalchemy python=3 six virtualenv pytest pytest-cov
conda activate cqlalchemy
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/cqlalchemy.git
   cd cqlalchemy
   ```
...
5. Install [pre-commit]:
   ...
   `cqlalchemy` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/cqlalchemy
[issue tracker]: https://github.com/<USERNAME>/cqlalchemy/issues
